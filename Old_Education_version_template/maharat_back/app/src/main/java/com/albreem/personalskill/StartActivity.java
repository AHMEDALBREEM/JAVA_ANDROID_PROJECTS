...
public class StartActivity extends Activity {
	...
	private void initializeLogic() {
		button12.setText("تعلم فن الكلام");
		button13.setText("نصائح لتحسين فن الكلام");
		button14.setText("تعلم فن الثقة بالنفس");
		button15.setText("تطوير الثقة بالنفس");
		button16.setText("لغة الجسد");
		button17.setText("تطوير لغة الجسد");
		button19.setText("تطوير المهارات الشخصية ");
		button18.setText("تعلم المهارات الشخصية");
		button20.setText("تعلم التحليل و التقييم");
		button21.setText("تطوير التحليل و التقييم");
		button22.setText("تعلم ادارة المسؤوليات الجماعية ");
		button23.setText("تطوير إدارة المسؤوليات الجماعية");
		button24.setText("تطوير فن التواصل الفعال ");
		button25.setText("تطوير فن إدارة الضغوط و إدارة الإجهاد ");
		button26.setText("تعلم فن حل مشكلات");
		button27.setText("تطوير حل المشكلات");
		x = 0;
				...
				public void onClick(DialogInterface _dialog, int _which) {
					...
					waring2.setPositiveButton("صفحة التطبيق", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface _dialog, int _which) {
							...
							intent.setAction(Intent.ACTION_VIEW);
							intent.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.albreem.personalskill"));
							startActivity(intent);
						}
					});
					waring2.create().show();
