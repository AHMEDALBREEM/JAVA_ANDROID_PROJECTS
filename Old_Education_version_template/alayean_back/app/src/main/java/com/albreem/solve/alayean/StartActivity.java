...
public class StartActivity extends Activity {
	...
	private void initializeLogic() {
		button12.setText("كيف نحافظ على العين");
		button13.setText("السواد تحت العين");
		button14.setText("نصائح لإزالة السواد تحت العينين");
		button15.setText("التخلص من انتفاخ العين نهائياً");
		button16.setText("أسباب حرقان العين عند البكاء");
		button17.setText("طرق المحافظة على سلامة العين");
		button19.setText("وجود ضباب على العين فجأة");
		button18.setText("كيف أتخلص من رفة العين");
		button20.setText("أسباب اصفرار العين");
		button21.setText("فوائد وضع الخيار على العين");
		button22.setText("أسباب زغللة العين");
		button23.setText("التخلص من تجاعيد تحت العين");
		button24.setText("ما أضرار البكاء على العين");
		button25.setText("ما هي حدقة العين");
		button26.setText("أسباب نبض العين");
		button27.setText("ما سبب الاحمرار تحت العين بعد البكاء");
		x = 0;
				...
				public void onClick(DialogInterface _dialog, int _which) {
					...
					waring2.setPositiveButton("صفحة التطبيق", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface _dialog, int _which) {
							...
							intent.setAction(Intent.ACTION_VIEW);
							intent.setData(Uri.parse("https://play.google.com/store/apps/details?id=".concat("com.albreem.solve.alayean")));
							startActivity(intent);
						}
					});
					waring2.create().show();
