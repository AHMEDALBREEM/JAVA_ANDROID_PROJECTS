package com.albreem.zeadaalwazeanoofline;
...
public class StartActivity extends Activity {
	...
	private void initializeLogic() {
		button12.setText("نحافة الأطفال أسبابها وعلاماتها وطرق علاجها");
		button13.setText("نصائح زيادة الوزن بطرق مضمونة");
		button14.setText("علاقة الموز بزيادة الوزن");
		button15.setText("وصفات طبيعية بزيادة الوزن");
		button16.setText("فوائد الخميرة لزيادة الوزن");
		button17.setText("زيادة الوزن 5 كيلو في اسبوع");
		button19.setText("وصفات الزيادة الوزن بسرعة في 15 يوم");
		button18.setText("زيادة الوزن بشكل عام");
		button20.setText("طرق مضمونة لزيادة الوزن");
		button21.setText("نصائح مهمة لتخفيف الوزن");
		button22.setText("مكلملات الغذائية لزيادة الوزن");
		button23.setText("فواكه تزيد الوزن");
		button24.setText("الاطعمة الغنية بالبروتين لزيادة الوزن");
		button25.setText("وصفات لتسمين الجسم");
		button26.setText("الوجبات زيادة الوزن ");
		button27.setText("اعشاب طبية لزيادة الوزن");
		x = 0;
		...
		if (f.contains("x")) {
			...
			waring.setPositiveButton("تقييم التطبيق", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface _dialog, int _which) {
					...
					intent.setAction(Intent.ACTION_VIEW);
					intent.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.albreem.zeadaalwazeanoofline"));
					startActivity(intent);
				}
			});
