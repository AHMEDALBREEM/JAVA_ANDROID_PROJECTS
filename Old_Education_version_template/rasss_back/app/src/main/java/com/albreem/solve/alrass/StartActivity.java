...
public class StartActivity extends Activity {
	...
	private void initializeLogic() {
		button12.setText("معلومات عامة عن الرأس");
		button13.setText("أنواع مختلفة من الصداع الرأس");
		button14.setText("علاج الالم الصداع");
		button15.setText("أسباب الصداع النصفي الأيمن");
		button16.setText("أسباب الصداع النصفي الأيسر");
		button17.setText("كيف أعالج ألم الرأس");
		button19.setText("أسباب وجع الرأس من الخلف");
		button18.setText("مشروبات لعلاج الصداع");
		button20.setText("وصفات لعلاج الصداع الشديد");
		button21.setText("وصفة لعلاج صداع الرأس");
		button22.setText("أسهل طريقة لعلاج الصداع");
		button23.setText("علاج الصداع دون أدوية");
		button24.setText("ما هو أفضل علاج للصداع");
		button25.setText("ما هي الشقيقة");
		button26.setText("علاج الشقيقة ");
		button27.setText("نصائح خاصة للمرأة ");
		x = 0;
				...
				public void onClick(DialogInterface _dialog, int _which) {
					...
					waring2.setPositiveButton("صفحة التطبيق", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface _dialog, int _which) {
							...
							intent.setData(Uri.parse("https://play.google.com/store/apps/details?id=".concat("com.albreem.solve.alrass")));
							startActivity(intent);
						}
					});
					waring2.create().show();
