...
public class StartActivity extends Activity {
	...
	private void initializeLogic() {
		button12.setText("طرق العناية بالقدمين");
		button13.setText("نصائح للعناية بالقدمين");
		button14.setText("كيفية العناية بقدم مريض السكري");
		button15.setText("أسباب تشقّق القدمين");
		button16.setText("الوصفات الطبيعية لتنعيم القدمين");
		button17.setText("ألم الكعب");
		button19.setText("طريقة تنعيم كعب القدم");
		button18.setText("أسباب حكة باطن القدم");
		button20.setText("8 نصائح للتخلص من رائحة القدم");
		button21.setText("وصفات للتخلص من رائحة القدمين الكريهة");
		button22.setText("ما سبب تورم القدمين");
		button23.setText("كيفية التخلص من مسمار الرجل");
		button24.setText("ماسك تقشير القدم");
		button25.setText("نقع القدمين بالماء والملح");
		button26.setText("ما هو السواد الركب");
		button27.setText("اسباب السود الركب");
		x = 0;
		...
		if (f.contains("x")) {
			...
			waring.setPositiveButton("تقييم التطبيق", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface _dialog, int _which) {
					...
					intent.setAction(Intent.ACTION_VIEW);
					intent.setData(Uri.parse("https://play.google.com/store/apps/details?id=".concat("com.albreem.solve.alkadam")));
					startActivity(intent);
				}
			});
