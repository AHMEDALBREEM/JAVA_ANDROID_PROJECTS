...
public class MainActivity extends Activity {
	...
	private RequestNetwork requestinternet;
	private RequestNetwork.RequestListener _requestinternet_request_listener;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		requestinternet = new RequestNetwork(this);
		
		_requestinternet_request_listener = new RequestNetwork.RequestListener() {
			@Override
	...
	private void initializeLogic() {
		requestinternet.startRequestNetwork(RequestNetworkController.GET, "https://www.google.com", "google", _requestinternet_request_listener);
	...
	public void onBackPressed() {
		SketchwareUtil.showMessage(getApplicationContext(), "أنتظر..");
	}
