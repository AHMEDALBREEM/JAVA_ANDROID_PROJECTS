...
public class Page2Activity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_fab.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (!last.getString("endedb", "").equals("")) {
					listview1.setSelection((int)Double.parseDouble(last.getString("endedb", "")));
				}
				else {
	...
	private void initializeLogic() {
		...
		try{
			java.io.InputStream inputstream1 = getAssets().open("2.json");
	...
	public void onBackPressed() {
		...
		last.edit().putString("endedb", String.valueOf((long)(one))).commit();
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			Animation animation;
			        ...
			        animation = null;
			last.edit().putString("b", String.valueOf((long)(_position))).commit();
			one = _position;
