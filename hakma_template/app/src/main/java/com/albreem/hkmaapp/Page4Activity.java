...
public class Page4Activity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_fab.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (!last.getString("endedd", "").equals("")) {
					listview1.smoothScrollToPosition((int)(Double.parseDouble(last.getString("endedd", ""))));
				}
				else {
	...
	private void initializeLogic() {
		...
		try{
			java.io.InputStream inputstream1 = getAssets().open("4.json");
	...
	public void onBackPressed() {
		...
		last.edit().putString("endedd", String.valueOf((long)(one))).commit();
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			Animation animation;
			        ...
			        animation = null;
			last.edit().putString("d", String.valueOf((long)(_position))).commit();
			one = _position;
