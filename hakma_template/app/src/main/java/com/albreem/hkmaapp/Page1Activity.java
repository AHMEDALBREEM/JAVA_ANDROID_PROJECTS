...
public class Page1Activity extends AppCompatActivity {
	...
	private ArrayList<HashMap<String, Object>> favorite = new ArrayList<>();
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_fab.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (!last.getString("ended", "").equals("")) {
					listview1.setSelection((int)Double.parseDouble(last.getString("ended", "")));
				}
				else {
	...
	private void initializeLogic() {
		...
		try{
			java.io.InputStream inputstream1 = getAssets().open("1.json");
	...
	public void onBackPressed() {
		...
		last.edit().putString("ended", String.valueOf((long)(one))).commit();
