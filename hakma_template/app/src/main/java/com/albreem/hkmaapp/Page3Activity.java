...
public class Page3Activity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_fab.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (!last.getString("endedc", "").equals("")) {
					listview1.smoothScrollToPosition((int)(Double.parseDouble(last.getString("endedc", ""))));
				}
				else {
	...
	private void initializeLogic() {
		...
		try{
			java.io.InputStream inputstream1 = getAssets().open("3.json");
	...
	public void onBackPressed() {
		...
		last.edit().putString("endedc", String.valueOf((long)(one))).commit();
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			Animation animation;
			        ...
			        animation = null;
			last.edit().putString("c", String.valueOf((long)(_position))).commit();
			one = _position;
