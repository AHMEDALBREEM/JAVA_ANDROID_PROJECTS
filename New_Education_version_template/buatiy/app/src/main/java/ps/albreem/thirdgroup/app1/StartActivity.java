...
public class StartActivity extends Activity {
	...
	private void initializeLogic() {
		imageview1.setImageResource(getResources().getIdentifier("jajs", "drawable", getPackageName()));
		if (Build.VERSION.SDK_INT >= 21) { Window
			w = this.getWindow();
			w.setNavigationBarColor(Color.parseColor("#000000")); }
		imageview1.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b) { this.setCornerRadius(a); this.setColor(b); return this; } }.getIns((int)30, 0xFFE658B5));
		try{
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			Animation animation;
			        ...
			        animation = null;
			button4.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b) { this.setCornerRadius(a); this.setColor(b); return this; } }.getIns((int)30, 0xFFE658B5));
			...
			button4.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View _view) {
					...
					intent.putExtra("link", map.get((int)_position).get("link").toString());
					startActivity(intent);
					finish();
				}
			});
