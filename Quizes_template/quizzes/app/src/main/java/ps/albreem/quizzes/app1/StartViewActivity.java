...
public class StartViewActivity extends Activity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				intent.putExtra("info", app_description);
	...
	private void initializeLogic() {
		...
		app_package = "ps.albreem.quizzes.app1";
		app_description = "تطبيق \"أسئلة عامة\" يتميز بأسئلته الشيقة والمميزة التي تغطي مجموعة واسعة من المواضيع الثقافية والعامة، مما يجعل تجربة الاستخدام مثيرة ومفيدة للمستخدمين من جميع الأعمار والخلفيات. يتيح لك حل هذه الأسئلة العامة فرصة تحفيز عقلك وتنشيط العضلات العقلية، مما يساعد في تحسين التفكير النقدي وتعزيز الذاكرة.";
